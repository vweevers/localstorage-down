...
require('abstract-leveldown/abstract/put-get-del-test').all(webstorage, test, testCommon, testBuffer);
...
require('abstract-leveldown/abstract/iterator-test').iterator(webstorage, test, testCommon, testCommon.collectEntries);
...
require('abstract-leveldown/abstract/approximate-size-test').setUp(webstorage, test, testCommon);
require('abstract-leveldown/abstract/approximate-size-test').args(webstorage, test, testCommon);

// Skip approximateSize test, we cannot implement it.
// require('abstract-leveldown/abstract/approximate-size-test').approximateSize(test);

require('abstract-leveldown/abstract/approximate-size-test').tearDown(webstorage, test, testCommon);
