...
WebstorageDown.prototype._getKeys = function (options) {
  ...
  var lt = serializer.serializeRange(options.lt);
  var lte = serializer.serializeRange(options.lte);
  var gt = serializer.serializeRange(options.gt);
  var gte = serializer.serializeRange(options.gte);
  var start = serializer.serializeRange(options.start);
  var end = serializer.serializeRange(options.end);
